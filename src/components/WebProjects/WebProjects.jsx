...
function WebProjects() {
    ...
    return (
        <>
            <div ref={ref} className='text-white max-w-screen-xs sm:max-w-screen-sm md:max-w-screen-md lg:max-w-screen-xl mx-auto mt-10 mb-28 relative z-10' id='projects'>
