...
<p className="text-white text-xs sm:text-sm">
  To keep in touch with me, send me a message on{" "}
  <a
    className="text-purple-500"
    target="_blank"
    href="https://www.linkedin.com/in/khaled-saed-09a1a0260/"
  >
    LinkedIn
  </a>{" "}
  or{" "}
  <a
    className="text-purple-500"
    href="mailto:ksaed110@gmail.com?subject=Hello%20Khaled&body=Hi%20Khaled,"
  >
    Email
  </a>
  .
