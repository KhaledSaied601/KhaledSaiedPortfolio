...
export function AirportFamiliesCarousel() {
    ...
    const familiesElement = [
        ...
        { image: SW, title: "Suspension Wire", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/SuspensionWire.frag" },
        { image: TL, title: "Tie Ladder with Fixation", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/TieLadder.frag" },
        { image: RS, title: "Roller Shutter", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/RollerShutter.frag" },
        { image: RP, title: "Roof Parapet", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/RoofParapet.frag" },
        { image: WI, title: "Window Fixation", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/Window.frag" },
        { image: DI, title: "Door with Fixation and Accessories", Has3D: true, modelPath: "KhaledSaiedPortfolio/frag/Fam/Door.frag" },
