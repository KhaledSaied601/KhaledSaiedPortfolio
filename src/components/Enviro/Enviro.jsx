...
function Enviro() {
    ...
    const generateShellGeometry = () => {
        const geometry = new THREE.ParametricGeometry((u, v, target) => {
            ...
            target.set(x * 0.5, y * 0.5 + 3, z * 0.5)
        }, 50, 50)
        return geometry
    }
    ...
    return (
        <>
            ...
            <mesh ref={shellRef} position={[0, 0, 0]}>
                <primitive object={generateShellGeometry()} />
                <meshPhongMaterial 
                    vertexColors={true} 
            ...
            <Sparkles ref={sparkles} count={70} size={0.8} scale={[1, 1.5, 0.8]} speed={0.1} color="lightblue" position-y={1.4} position-z={-0.1} />
