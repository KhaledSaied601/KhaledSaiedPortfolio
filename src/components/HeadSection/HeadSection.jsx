...
function HeadSection() {
    ...
    return (
        <>
            ...
            <div className='head-section bg-[url("./assets/images/cover.webp")] bg-center bg-fixed flex items-center justify-start   bg-cover h-screen head-section w-full mb-32  mx-auto border-s border-gray-500 border-opacity-0 border-dotted delay-400 duration-200  relative ' id='home'>
